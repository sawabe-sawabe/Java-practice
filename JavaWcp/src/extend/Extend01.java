...
public class Extend01 {
	public static void main(String[] args) {
		...
		System.out.println("Humanクラスメゾット：名前は、"+ sugimoto.getName());
		
		Student sato = new Student("佐藤",17,70);
		System.out.println("Humanクラスメゾット：名前は、"+ sato.getName());
		System.out.println("Studentクラスメゾット：プロフィールを紹介します。" + sato.getStudentProfile());
		
		Human human = new Employee("田中",28,"システム部");
		System.out.println("Humanクラスメゾット：名前は、"+ human.getName());
	    Employee tanaka = (Employee) human;
	    System.out.println("Employeeクラスメゾット：プロフィールを紹介します。" + tanaka.getEmployeeProfile());
